...
echo "4th <server IP>, 5th <server's FQDN>, 6th <server's hostname> 7th <server's password>"
exit
else
if [ -f /etc/debian_version ]; then
echo "Its ubuntu or debian"
...
sudo sshpass -p $7 scp -o StrictHostKeyChecking=no $6@$4:/home/server/pem/$2-validator.pem /etc/chef
...
sshpass -p $7 scp -o StrictHostKeyChecking=no $6@$4:/home/server/pem/$2-validator.pem /etc/chef
